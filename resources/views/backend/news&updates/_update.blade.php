        ...
        <div class="modal-body">
         <div class="input-group mb-3">
          ...
          <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" name="content" value="{{$news->content}}"required>
          </div>
          <div class="input-group mb-3">
          ...
          <img src="{{asset('storage/'.$news->image) }}" height="60" width="60"style=" border: 1px solid #555;"id="imageShow">
        </div>
