      ...
      <form action="{{ route('qualification.update', $quali->id) }}" method="post">
        ...
        <div class="modal-body">
          <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" name="title" value="{{ $quali->title}}" >
          </div>
          <div class="input-group mb-3">
           <span class="input-group-text">CPTR Number</span>
            <input type="text" class="form-control" name="cptr" value="{{$quali->cptr}}" >
          </div>
           <div class="input-group mb-3">
            <span class="input-group-text">Date Accredited</span>
            <input type="date" class="form-control" name="date" value="{{$quali->date}}" >
          </div>
          <div class="input-group mb-3">
           <span class="input-group-text">Hours</span>
            <input type="text" class="form-control" name="hrs" value="{{$quali->hrs}}" >
          </div>
           <div class="input-group mb-3">
           <span class="input-group-text">Type</span>
            <input type="text" class="form-control" name="type" value="{{$quali->type}}" >
          </div>
