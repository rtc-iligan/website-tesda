        ...
        <div class="masonry">
            ...
            <div class="masonry__container row masonry--active">
                <div class="masonry__item col-lg-4 col-6 filter-people" data-masonry-filter="People">
                    <a href="img/building.jpg" data-lightbox="Gallery 1"> <img alt="Image" src="img/building.jpg"> </a>
                </div>
                 <div class="masonry__item col-lg-4 col-6 filter-people" data-masonry-filter="People">
                    <a href="img/tesdabuilding.png" data-lightbox="Gallery 1"> <img alt="Image" src="img/tesdabuilding.png"> </a>
                </div>
               <div class="masonry__item col-lg-4 col-6 filter-people" data-masonry-filter="People">
                    <a href="img/IMG-2891.jpg" data-lightbox="Gallery 1"> <img alt="Image" src="img/IMG-2891.jpg"> </a>
                </div>
            </div>
        </div>
    </div>
