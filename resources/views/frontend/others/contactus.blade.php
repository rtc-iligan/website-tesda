...
<section>
    <div class="row col-md-12" style="align-items: center;justify-content: center;">
        ...
        <div class="col-md-5 card">
            <div class="card-body">
                ...
                <div class="col-9">
                    <a class="lead"><b>Email:</b>rtciligan@tesda.gov.ph</a><br>
                    <a class="lead"><b>Contact Number:</b>221-6541</a><br>
                    <a class="lead"><b>Address:</b>Maria Cristina, Iligan City 9200</a>
                </div>
                </div>
        ...
        <div class="col-md-5 card">
            ...
            <div class="row">
                ...
                <div class="col-9">
                    <a class="lead"><b>Email:</b>registrarofficertciligan@gmail.com</a><br>
                    <a class="lead"><b>Contact Number:</b>09976072537</a><br>
                    <a class="lead"><b>Address:</b>Maria Cristina, Iligan City 9200</a>
                </div>
                </div>
            </div>
    ...
    <div class="container col-md-8 mb-3">
        <p class="--avt-fs3 text-center">Feedback, Comments, Questions and Suggestions</p>
        <div class="card-body">
            <form>
